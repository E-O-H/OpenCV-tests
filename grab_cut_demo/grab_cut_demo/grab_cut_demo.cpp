// grab_cut_demo.cpp : Defines the entry point for the console application.
//
...
static void getBinMask(const Mat& comMask, Mat& binMask)
{
	//if (comMask.empty() || comMask.type() != CV_8UC1)
		 //CV_Error(Error::StsBadArg, "comMask is empty or has incorrect type (not CV_8UC1)"); // *unresolved bug
